...
interface IConfirmPictureDeleteModalProps {
  isOpen: boolean;
  onClose: () => void;
  imageName: string;
  imageID: string;
...
const ConfirmPictureDeleteModal: React.FunctionComponent<
  IConfirmPictureDeleteModalProps
> = ({
  isOpen,
  imageName,
  onClose,
      ...
      >
        ...
        >
          ...
          <Text
            ...
            align="center"
          >
            Are you sure you want to delete “{imageName}”? You can’t undo this
            action.
          </Text>
          ...
          <Flex direction="row" mt="30px">
            ...
            >
              {deleting ? "Deleting Image" : "Yes, Delete Image"}
              {deleting ? <Spinner w="20px" h="20px" /> : ""}
            </ChakraButton>
          </Flex>
...
export default ConfirmPictureDeleteModal;
