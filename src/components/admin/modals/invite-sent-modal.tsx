import { Image, Modal, ModalOverlay, ModalContent, ModalBody, ModalCloseButton, Text } from '@chakra-ui/react'
			...
			>
				...
				>
					...
					>
						...
						<Text fontWeight='400' fontSize='16px' lineHeight='21px' color='#666666'>
