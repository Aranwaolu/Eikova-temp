...
const AddAdminModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
	...
	const handleFullNameInputChange = (e: any) => {
		setPersonObject((prevState) => ({ ...prevState, fullName: e.target.value }))
	}
			...
			>
				...
				>
					...
					<ModalBody
						...
						margin='44px 0'
					>
						<Text fontWeight='500' fontSize='24px' lineHeight='31px' color='#262626' mb='8px'>
							Add Admin
						</Text>

						<Text fontWeight='400' fontSize='14px' lineHeight='19px' color='#A0A0A0' mb='15px'>
							*An admin can add or disable contributors and users
						</Text>

						<Box borderBottom='1px solid #E8E8E8' width='100%' mb='18px'></Box>

						<Text fontWeight='400' fontSize='14px' lineHeight='18px' color='#666666' mb='18px'>
						...
						<Text marginTop='10px' fontSize='14px' lineHeight='19px' color='#A0A0A0'>
